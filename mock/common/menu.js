...
const menuList = [
  ...
  { id: '6-4', pid: '6', name: '字典管理', path: '/system/dict', icon: '', cmpPath: 'pages/system/dict', menuType: '2', isShow: '1', isRouter: '1', permission: 'system:dict:list', sort: 4, status: '1', createTime: Random.datetime('yyyy-MM-dd HH:mm:ss'), remark: '' },
  { id: '6-4-1', pid: '6-4', name: '字典数据', path: '/system/dict-item', icon: '', cmpPath: 'pages/system/dict/dictItem', menuType: '2', isShow: '0', isRouter: '1', permission: 'system:dict:data:list', sort: 1, status: '1', createTime: Random.datetime('yyyy-MM-dd HH:mm:ss'), remark: '' },
  { id: '6-5', pid: '6', name: '部门管理', path: '/system/dept', icon: '', cmpPath: 'pages/system/dept', menuType: '2', isShow: '1', isRouter: '1', permission: 'system:dept:list', sort: 5, status: '1', createTime: Random.datetime('yyyy-MM-dd HH:mm:ss'), remark: '' },
